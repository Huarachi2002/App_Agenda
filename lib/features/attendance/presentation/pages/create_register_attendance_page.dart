...
class CreateRegisterAttendancePage extends ConsumerStatefulWidget {
  const CreateRegisterAttendancePage({Key? key}) : super(key: key);

  @override
  ConsumerState<CreateRegisterAttendancePage> createState() => _CreateRegisterAttendancePageState();
}

class _CreateRegisterAttendancePageState extends ConsumerState<CreateRegisterAttendancePage> {
